...
typedef struct {
  ...
  int arma[4]; //arma[0] gasta pouca energia e tira 'arma[1]' de saude do adversario; arma[2] gasta mais energia, 
  //            porem retira 'arma[3]' de saude do adversario. No caso, arma[0] e arma[1] representam 1 tipo de arma
